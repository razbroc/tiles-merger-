...
namespace DbQueriesTests
{
    ...
    public class DBTests
    {
            ...
            get
            {
                return new[]
                {
                    new object[] { 
                        ...
                        new Coordinate(31.2663935002085, 31.1786148130457), X_MAX_COL, Y_MAX_COL
                    }
                };
            }
        }
        ...
        public void TestAxisEdgeCoordinateMax(List<TileContent> contentToAdd, Coordinate expected, int xCol, int yCol)
        {
            // ARRANGE
            ...
            // ACT
            Coordinate actualCoordinate = DbQueries.AxisEdgeCoordinates(Math.Max, xCol, yCol, fakeConnection);
        ...
        [TestMethod]
        [DynamicData(nameof(AdditionData))]
        public void TestAxisEdgeCoordinateMin(List<TileContent> contentToAdd, Coordinate expected, int xCol, int yCol)
        {
            // ARRANGE
            string path = InMemoryDBTemplate.GetGpkgPath();
            SQLiteConnection fakeConnection = new SQLiteConnection($"Data Source={path}");
            ...
            // ACT
            Coordinate actualCoordinate = DbQueries.AxisEdgeCoordinates(Math.Min, xCol, yCol, fakeConnection);
